...
page_table_entry support1(page_table_entry pte,int a);

page_table_entry support2(page_table_entry pte,int a);

page_table_entry support3(page_table_entry pte,int a);

page_table_entry support4(page_table_entry pte,int a);
